...
timelimit -t 60 -T 1 $1 -t 0 -i 50000 -m 8192 --input_syntax tptp -stat full -sa discount -si on -rawr on -rtra on --random_seed $$ -spt on $2 $3 > "$4"/`(./filenamify_path.sh "$2")`.log 2>&1
exit 0
