...
CUMULATIVE_LOSS_SCALING : Final[bool] = True
CUM_STALE_AFTER = 6 # if we can't solve a problem for this many loops, let's give up on it
...
AUGMENT_TRAINING = None # " --sample_strategy preprocess.smp" # (capitalising on random seed that's anyway being varied); the random strategy is captured and transferred to the gather run
