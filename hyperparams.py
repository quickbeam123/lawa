...
PROBLEM_LIST = "../deeper/all246277shuffled125000head.txt" # just faking this (we rely on the explicit split in B-mesh-th1-split-120K, to be shared with Honza too)
NUM_TRAIN_PROBLEMS = 120000
EVAL_ON_TEST = True
