...
def stage_perf_gather():
  global script_model_to_steal
...
def stage_build_loss_matrix():
  global active_tweak_selection
...
if __name__ == "__main__":
  ...
  while True:
    ...
    # STAGE 2a: alternate EVAL, TRAIN, EVAL until no longer improving
    print()
    sys.stdout.flush()
    stage_start_time = time.time()
    ...
    loss_matrix = stage_build_loss_matrix()
